...
export const metadata: Metadata = { title: "Părinți înregistrați" };
    ...
    <div className="max-w-5xl">
      ...
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold">
          Părinți înregistrați{count != null ? ` (${count})` : ""}
        </h1>
      ...
      {rows.length === 0 ? (
        <div className="text-center py-16 bg-white rounded-xl border">
          <p className="text-gray-500">Niciun părinte înregistrat încă.</p>
        </div>
      ) : (
        <>
