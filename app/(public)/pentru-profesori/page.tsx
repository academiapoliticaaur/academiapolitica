...
export const metadata: Metadata = {
  title: "Platformă educațională pentru cadre didactice — Ami & Moti",
...
const STEPS = [
  {
    icon: "1️⃣",
    title: "Creezi un cont de cadru didactic",
    desc: "Înregistrare gratuită în 2 minute. Selectezi tipul Învățător (cls. 0–4) sau Profesor (cls. 5–8). Contul se activează după o scurtă aprobare administrativă.",
  },
  {
    icon: "2️⃣",
...
const FEATURES = [
  {
    ...
    desc: "Elevii accesează clasa la /clasa/COD-CLASA. Nu necesită cont, email sau parolă.",
  },
  {
...
const FAQS = [
  ...
  {
    q: "Este gratuit pentru cadre didactice?",
    a: "Da, accesul pentru cadre didactice este gratuit. Creezi cont, creezi clase, adaugi elevi și asignezi cursuri fără niciun cost.",
  },
  {
  ...
  {
    q: "Cât durează aprobarea contului de cadru didactic?",
        ...
        <div className="container mx-auto max-w-5xl px-4 py-20 sm:py-28">
          <div className="flex items-center gap-2 mb-4">
            <span className="text-xs font-bold tracking-widest uppercase bg-white/20 px-3 py-1 rounded-full">
              Gratuit pentru cadre didactice
            </span>
          </div>
      ...
      <section className="bg-gray-50 py-20">
        <div className="container mx-auto max-w-5xl px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500">Instrumente gândite pentru cadre didactice, nu pentru IT</p>
          </div>
      ...
      <section className="bg-white py-20">
        <div className="container mx-auto max-w-3xl px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-2">
            {[
              { step: "1", text: "Elevul accesează", sub: "ami-moti.ro/clasa" },
              { step: "→", text: "" , sub: "" },
      ...
      <section className="bg-gradient-to-r from-indigo-50 to-purple-50 py-16">
        <div className="container mx-auto max-w-4xl px-4">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              { icon: "🌈", title: "Învățători cls. 0–4", desc: "Cursuri de AI literacy și competențe digitale adaptate ciclului primar." },
      ...
      <section className="bg-indigo-700 text-white py-20">
        <div className="container mx-auto max-w-2xl px-4 text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-6 text-sm text-indigo-300">
            ...
            <span className="flex items-center gap-1.5"><CheckCircle size={14} /> Gratuit pentru cadre didactice</span>
          </div>
        </div>
      </section>
