...
export const metadata: Metadata = { title: "Diplomă de absolvire — Academia Politica AUR" };

export default async function ClassStudentCertificatePage({
  params,
}: {
  params: Promise<{ code: string; studentCode: string; certId: string }>;
}) {
  const { code, studentCode, certId } = await params;
  const db = createAdminClient();

  // Validate class + student (security check via URL params)
  ...
  const backUrl = `/grup/${code.toUpperCase()}/${studentCode.toUpperCase()}`;
    ...
    <>
      ...
      <div className="no-print flex items-center justify-between gap-3 px-4 py-3 bg-white border-b mb-6 flex-wrap">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <ShareButtons
            shareUrl={`${process.env.NEXT_PUBLIC_SITE_URL}/grup/${code.toUpperCase()}/${studentCode.toUpperCase()}/certificate/${certId}`}
            courseTitle={cert.course_title}
            childName={cert.student_name}
          />
          <PrintButton />
        </div>
      </div>
        ...
        >
          ...
          <div className="flex items-start justify-between gap-4 mb-4">
            ...
            <div className="flex-1 text-center">
              ...
              <div className="mt-2">
                <span
                  className="text-sm font-semibold px-6 py-1 border rounded"
            ...
            {/* Right: congratulations box */}
            <div
              className="w-44 text-white p-3 rounded text-center flex-shrink-0"
          ...
          <div className="text-center mb-3">
            ...
            <h2
              className="font-black text-gray-900 inline-block pb-1 px-8"
          ...
          <div className="flex items-end justify-between mt-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                <div
                  className="text-sm font-semibold text-gray-700 pb-0.5"
                  style={{ borderBottom: "1px solid #9ca3af", minWidth: "160px" }}
                >
                  {issueDate}
                </div>
            ...
            <div className="text-center">
              ...
              <p className="text-xs font-bold mt-1" style={{ color: "#0f766e" }}>
