...
export const metadata: Metadata = { title: "Zona mea — Academia Politica AUR" };
      ...
      <div className="max-w-2xl mx-auto">
        ...
        {courses.length > 0 ? (
          <div className="space-y-4">
            ...
            {courses.map((course) => (
              <Link key={course.id} href={`/grup/${code.toUpperCase()}/${studentCode.toUpperCase()}/course/${course.slug}`}>
