...
export const metadata: Metadata = { title: "Curs — Academia Politica AUR" };
...
export default async function StudentCoursePage({
  ...
  const baseUrl = `/grup/${code.toUpperCase()}/${studentCode.toUpperCase()}/course/${courseSlug}`;
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 p-4">
      <div className="max-w-2xl mx-auto">
        <div className="mt-2 mb-6">
          <Link
            href={`/grup/${code.toUpperCase()}/${studentCode.toUpperCase()}`}
        ...
        {isCourseComplete && (
          <div className="bg-gradient-to-r from-yellow-400 to-orange-400 text-white rounded-xl p-5 mb-4 text-center">
            ...
            {certificateId && (
              <Link
                href={`/grup/${code.toUpperCase()}/${studentCode.toUpperCase()}/certificate/${certificateId}`}
