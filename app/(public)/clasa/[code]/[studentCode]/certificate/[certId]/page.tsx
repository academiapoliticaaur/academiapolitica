...
export const metadata: Metadata = { title: "Diplomă de absolvire — Ami & Moti" };
...
export default async function ClassStudentCertificatePage({
  ...
  const backUrl = `/clasa/${code.toUpperCase()}/${studentCode.toUpperCase()}`;
    ...
    <>
      ...
      <div className="no-print flex items-center justify-between gap-3 px-4 py-3 bg-white border-b mb-6 flex-wrap">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <ShareButtons
            shareUrl={`${process.env.NEXT_PUBLIC_SITE_URL}/clasa/${code.toUpperCase()}/${studentCode.toUpperCase()}/certificate/${certId}`}
